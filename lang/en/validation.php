...
return [
    ...
    | usadas pela classe de validação. Algumas dessas regras têm várias versões,
    ...
    */
    ...
    'password' => [
        ...
        'uncompromised' => 'O :attribute fornecido foi comprometido em uma violação de dados. Escolha outro :attribute.',
    ],
    ...
    |----------------------------------------------------------------------
    |
    | Aqui você pode adicionar suas próprias mensagens de validação personalizadas.
    | Apenas substitua o "attribute" pelo nome do campo. Por exemplo:
    |
    | 'custom' => [
    |     'attribute-name' => [
    ...
    */
    ...
    |----------------------------------------------------------------------
    |
    | Você pode substituir os nomes dos atributos para algo mais legível.
    |
    */
